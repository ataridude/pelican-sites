...
AUTHORS = {
    u'Daniel': 'https://forsale.unixdude.net',
}

SITENAME = 'forsale.unixdude.net'
SITEURL = 'https://forsale.unixdude.net'
...
PLUGINS = ["tag_cloud", "tipue_search", "assets", "read_more_link"]
...
CODE_HIGHLIGHT = 'https://forsale.unixdude.net/theme/css/solarized-dark.css'
...
SIDEBAR_ABOUT_TITLE = "Daniel's Forsale items"
SIDEBAR_ABOUT = "This site shows some of the items that I currently have for sale"
